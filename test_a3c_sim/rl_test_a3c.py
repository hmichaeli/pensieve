...
def main():
    ...
    a3c_file = sys.argv[2]
    log = sys.argv[3]
    print("[main] dynamic import a3c: {}".format(a3c_file))
    a3c = importlib.import_module(a3c_file)

    NN_MODEL = model + '.ckpt'
    LOG_FILE = './results/log_sim_' + log

    test_model(NN_MODEL, LOG_FILE)

    #
    # if a3c_file == 'a3c':
    #     LOG_FILE = './results/log_sim_' + 'a3c_orig'
    # else:
    #     LOG_FILE = './results/log_sim_' + a3c_file
    # test_model(NN_MODEL, LOG_FILE)
    # #
    # epoch = sys.argv[1]
    # if int(epoch) < 0:
