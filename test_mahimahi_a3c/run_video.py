...
#TODO: check if can get multiple requests
...
try:
	...
	# if abr_algo == 'RL':
	if 'RL' in abr_algo:
		command = 'exec /usr/bin/python ../rl_server/rl_server_test_mahimahi_a3c.py ' +\
				  trace_file + ' ' + nn_model + ' ' + abr_algo + ' ' + \
			a3c_file + ' ' + log_name

		# command = 'exec /usr/bin/python ../rl_server/training_rl_server.py ' + trace_file
	else:
		log("ERROR - not RL algo")
		exit()
