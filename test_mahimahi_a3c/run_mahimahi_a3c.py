...
MODELS_DIR = '/home/haggai/projects/networkML/pensieve/test_mahimahi_a3c/nn_models/'

server_offset = 0 # will use RL-# , # starting offset
...
for i, (nn_model, a3c, log_f) in enumerate(zip(MODELS, A3C, log_name)):
	...
	command_RL = 'python run_traces.py ' + TRACE_PATH + ' ' + ABR_ALGO + \
				 ' ' + str(PROCESS_ID) + ' ' + ip + ' ' + nn_model_path + ' ' + a3c + ' ' + log_f
